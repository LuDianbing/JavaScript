...
```json
{"name":"张三", "age":31, "major":"WEB前端", "tags": ["老司机", "实力唱将"]}
```
...
代码示例：
  ```js
  var obj = { name: "张三",	age: 31,	major: "WEB前端",	tags: ["老司机", "实力唱将"] }
  JSON.stringify(obj); 
...
代码示例：
  ```js
  var json = '{"name":"张三","age":31,"major":"WEB前端","tags":["老司机","实力唱将"]}';
  JSON.parse(json);
  
  // {name: "张三", age: 31, major: "WEB前端", tags: Array(2)}
  ```
